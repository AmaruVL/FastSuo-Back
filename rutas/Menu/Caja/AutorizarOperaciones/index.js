...
rutas_trasferencias.get("/buscar/:query/:fechaInicio/:fechaFin/:oficina_origen/:oficina_destino/:estado", transferencia.buscarcentral);
...
rutas_trasferencias.put("/autorizar", transferencia.autorizar);
