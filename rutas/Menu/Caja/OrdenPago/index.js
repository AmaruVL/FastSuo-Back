...
rutas_trasferencias.get("/buscar/:query/:fechaInicio/:fechaFin", transferencia.buscar); //guardaTransferencias
//NIVEL >= 3
...
rutas_trasferencias.post("/cancelar", [verificarOficina.verificarOfOrigen()], transferencia.cancelar); //guardaTransferencias
...
rutas_trasferencias.get("/cliente/:id_cliente", cliente.buscar);
//NIVEL >= 4
