...
//
rutas_cuentas.put("/actualizar/:perfil_codigo", [verificarPerfil(4)], perfiles.actualizar);
rutas_cuentas.put("/desactivar/:perfil_codigo", [verificarPerfil(5)], perfiles.desactivar);
