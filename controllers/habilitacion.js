                    ...
                    .create(
                      {
                        ...
                        cliente_razon_social:
                          "Habilitacion -" + req.body.destino_oficina_codigo, //BODY
                        ...
                        moneda1_Egre:
                          req.body.moneda === "SOLES" ? parseFloat(req.body.importe) : 0, //?suma de valores??????			//BODY
                        moneda2_Ingre: 0,
                        moneda2_Egre:
                          req.body.moneda === "DOLARES"
                      ...
                      return models.habilitacion.create(
                        {
                          ...
                          encargado_operacion_id_cliente:
                            req.body.encargado_operacion_id_cliente,
                          autorizada: 1,
                        },
                        {
                          transaction: t,
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionEgreso(
              ...
              "HABILITACION",
              result.importe,
              `Habilitacion realizada por un monto de ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(result.importe)}`,
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionIngreso(
              ...
              "AMORTIZACION",
              result.importe,
              `Amortizacion realizada por un monto de ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(result.importe)}`,
              `Origen: ${caja_origen} Destino: ${caja_destino}`,
              `${result.origen_docu_codigo}${result.origen_docu_serie}-${result.origen_nro_operacion}`,
                      ...
                      .create(
                        {
                          ...
                          tipo_cambio: 0, //BODY
                          moneda1_Ingre:
                            habilitacion.moneda === "SOLES" ? habilitacion.importe : 0, //???suma de valores?????? //BODY
                          moneda1_Egre: 0, //?suma de valores??????			//BODY
                          moneda2_Ingre:
                            habilitacion.moneda === "DOLARES" ? habilitacion.importe : 0,
                          moneda2_Egre: 0,
                          moneda3_Ingre: 0,
                          moneda3_Egre: 0,
                          modulo: "Habilitacion",
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionIngreso(
              ...
              `Habilitacion aceptada por un monto de ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(habilitacionBuscada.importe)}`,
              `Origen: ${caja_origen} Destino: ${caja_destino}`,
        ...
        return models.habilitacion
          ...
          .then(habilitacion => {
            if (
              ...
              (habilitacion.tipo_habilitacion === "ENTRECAJAS" ||
                habilitacion.tipo_habilitacion === "DEPOSITO")
            ) {
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionIngreso(
              ...
              "HABILITACION",
              habilitacionBuscada.importe,
              `Habilitacion ANULADA por un monto de ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(habilitacionBuscada.importe)}`,
              `Origen: ${caja_origen} Destino: ${caja_destino}`,
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionIngreso(
              ...
              "AMORTIZACION",
              habilitacionBuscada.importe,
              `Amortizacion ANULADA por un monto de ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(habilitacionBuscada.importe)}`,
              `Origen: ${caja_origen} Destino: ${caja_destino}`,
              `${habilitacionBuscada.origen_docu_codigo}${habilitacionBuscada.origen_docu_serie}-${habilitacionBuscada.origen_nro_operacion}`,
          ...
          return models.habilitacion
            ...
            .then(async habilitacion => {
              ...
              if (documentoSerie == null) {
                throw new Error(
                  "Oficina no cuenta con documento para realizar anulacion",
                );
              }
                        ...
                        .create(
                          {
                            ...
                            tipo_cambio: 0, //BODY
                            moneda1_Ingre:
                              habilitacion.moneda == "SOLES"
                                ? parseFloat(habilitacion.importe)
                                : 0, //?suma de valores??????			//BODY
                            moneda1_Egre: 0,
                            moneda2_Ingre:
                              habilitacion.moneda == "DOLARES"
                                ? parseFloat(habilitacion.importe)
                                : 0,
                            moneda2_Egre: 0,
                            moneda3_Ingre: 0,
          ...
          models.sequelize
            ...
            .then(respuesta => {
              ...
              NotificacionEgreso(
                ...
                "HABILITACION",
                habilitacionBuscada.importe,
                `Habilitacion ANULADA por central, monto: ${Intl.NumberFormat("en-US", {
                  minimumFractionDigits: 2,
                }).format(habilitacionBuscada.importe)}`,
                `Origen: ${caja_origen} Destino: ${caja_destino}`,
                `${habilitacionBuscada.origen_docu_codigo}${habilitacionBuscada.origen_docu_serie}-${habilitacionBuscada.origen_nro_operacion}`,
        ...
        models.sequelize
          ...
          .then(respuesta => {
            ...
            NotificacionEgreso(
              ...
              "AMORTIZACION",
              habilitacionBuscada.importe,
              `Amortizacion ANULADA por central, monto: ${Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2,
              }).format(habilitacionBuscada.importe)}`,
              `Origen: ${caja_origen} Destino: ${caja_destino}`,
              `${habilitacionBuscada.origen_docu_codigo}${habilitacionBuscada.origen_docu_serie}-${habilitacionBuscada.origen_nro_operacion}`,
      ...
      .then(objeto => {
        if (objeto) {
          ...
          logger.log("warn", {
            ...
            token: token,
            message:
              "Su habilitacion no existe o usted no puede acceder a esta informacion",
          });
          res
            .status(400)
            .send(
      ...
      .then(documentoSerie => {
        if (documentoSerie == null) {
          logger.log("warn", {
            ubicacion: filename,
            token: token,
            message: "Oficina no cuenta con documento de habilitaciones",
          });
          ...
          [Op.or]: [
            ...
            },
            {
              [Op.and]: [
                ...
                {
                  createdAt: {
                    [Op.gte]: moment().subtract(1, "days").format("L"),
                  },
                },
              ],
            },
    ...
    models.habilitacion
      .findAll({
        ...
        where: {
          createdAt: {
            [Op.between]: [
              req.params.fechaInicio + " 00:00:00.000 -05:00",
              req.params.fechaFin + " 23:59:59.000 -05:00",
            ],
          },
          ...origen_oficina_codigo,
          ...destino_oficina_codigo,
      ...
      if (cajaAnterior) {
        ...
        if (cajaAnterior.estado_caja === "CERRADO") {
          ...
          const mensaje =
            ...
            moment(cajaAnterior.fecha_trabajo).locale("es").format("LLLL") +
