...
function NotificacionIngreso(redis, socket, tipo, importe, texto1, texto2, texto3, usuario, caja) {
  ...
  models.notificacion
    ...
    .then(notif => {
      notificacion = notif;
      //  BUSCAR USUARIOS DE CAJA AFECTADA
...
function NotificacionEgreso(redis, socket, tipo, importe, texto1, texto2, texto3, usuario, caja) {
  let notificacion = null;
  models.notificacion
    .create({
      fecha_registro: Date.now(),
