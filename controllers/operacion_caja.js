        ...
        if (req.body.accion === "VENTA") {
          if (parseFloat(req.body.importe_dolares) > saldos.saldo2) {
            logger.log("warn", {
              ubicacion: filename,
              token: token,
              message: "No tiene dolares suficientes en caja",
            });
          ...
          if (parseFloat(req.body.importe_soles) > saldos.saldo1) {
            logger.log("warn", {
              ubicacion: filename,
              token: token,
              message: "No tiene soles suficientes en caja",
            });
          ...
          logger.log("warn", {
            ubicacion: filename,
            token: token,
            message: "Opcion de tipo de cambio no especificada",
          });
                      ...
                      return models.operacion_caja.create(
                        {
                          ...
                          moneda1_Ingre:
                            req.body.accion === "VENTA" ? req.body.importe_soles : 0, //???suma de valores?????? //BODY
                          moneda1_Egre:
                            req.body.accion === "COMPRA" ? req.body.importe_soles : 0, //?suma de valores??????			//BODY
                          moneda2_Ingre:
                            req.body.accion === "COMPRA" ? req.body.importe_dolares : 0,
                          moneda2_Egre:
                            req.body.accion === "VENTA" ? req.body.importe_dolares : 0,
                          moneda3_Ingre: 0,
                          moneda3_Egre: 0,
                          modulo: "Tipo cambio",
        ...
        if (req.body.accion === "VENTA") {
          if (parseFloat(req.body.importe_otros) > saldos.saldo3) {
            logger.log("warn", {
              ubicacion: filename,
              token: token,
              message: "No tiene monedas suficientes en caja",
            });
                      ...
                      return models.operacion_caja.create(
                        {
                          ...
                          moneda2_Egre: 0,
                          moneda3_Ingre:
                            req.body.accion === "COMPRA" ? req.body.importe_otros : 0,
                          moneda3_Egre:
                            req.body.accion === "VENTA" ? req.body.importe_otros : 0,
                          modulo: "Materiales", //---------------------?????????????????
                          usuario: tokenDecodificado.id,
                          estado_registro: 2,
                        },
      ...
      .then(objeto => {
        if (objeto) {
          ...
          logger.log("warn", {
            ubicacion: filename,
            token: token,
            message: "No se encontro la operacion",
          });
