...
exports.saldos_empresa = (req, res) => {
  ...
  utils.decodeToken(token, tokenDecodificado => {
    ...
    var oficina_codigo = req.body.oficina_cod;
    var fecha_inicio = req.body.fecha_inicio;
    var fecha_fin = req.body.fecha_fin;

    models.sequelize
      .query(`SELECT * FROM saldos_oficina2(:fecha_inicio,:fecha_fin,:oficina_cod)`, {
        replacements: {
          fecha_inicio: fecha_inicio,
          fecha_fin: fecha_fin,
          oficina_cod: oficina_codigo,
        },
...
exports.pdfDetalle = (req, res) => {
  ...
  utils.decodeToken(token, async tokenDecodificado => {
    ...
    models.sequelize
      .query(
        `SELECT * from giros_oficina('${oficina_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
        {
          type: models.sequelize.QueryTypes.SELECT,
        },
      )
      .then(lista => {
        var ops = lista.map(function (item) {
          ...
          arrValores[5] = {
            text: Intl.NumberFormat("en-US", { minimumFractionDigits: 2 }).format(
              arrValores[5],
            ),
            noWrap: true,
            alignment: "right",
        ...
        models.sequelize
          .query(
            `SELECT * from orden_pago_oficina('${oficina_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
            {
              type: models.sequelize.QueryTypes.SELECT,
            },
          )
          .then(lista2 => {
            ...
            models.sequelize
              .query(
                `SELECT * from recibos_oficina2('${oficina_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
                {
                  type: models.sequelize.QueryTypes.SELECT,
                },
              )
              .then(lista3 => {
                ...
                models.sequelize
                  .query(
                    `SELECT * from servicios_oficina('${oficina_codigo1}', '${fechai}', '${fechaf}')`,
                    {
                      type: models.sequelize.QueryTypes.SELECT,
                    },
                  )
                  .then(lista4 => {
                    ...
                    models.sequelize
                      .query(
                        `SELECT * from saldos_oficina2('${fechai}','${fechaf}','${oficina_codigo1}')`,
                        {
                          type: models.sequelize.QueryTypes.SELECT,
                        },
                      )
                      .then(listasaldos => {
                        ...
                        var docDefinition = {
                          ...
                          content: [
                            ...
                            },
                            {
                              columns: [
                                ...
                                },
                                {
                                  ...
                                  text: `${Intl.NumberFormat("en-US", {
                                    minimumFractionDigits: 2,
                                  }).format(listasaldos[0].soles_anterior)}`,
                                  style: "monto",
                                },
                                {
                                  // fixed width
                                ...
                                },
                                {
                                  ...
                                  text: `${Intl.NumberFormat("en-US", {
                                    minimumFractionDigits: 2,
                                  }).format(listasaldos[0].dolares_anterior)}`,
                                  style: "monto",
                                },
                                {
                                  // fixed width
                            ...
                            },
                            {
                              columns: [
                                ...
                                },
                                {
                                  ...
                                  text: `${Intl.NumberFormat("en-US", {
                                    minimumFractionDigits: 2,
                                  }).format(listasaldos[0].soles_final)}`,
                                  style: "monto",
                                },
                                {
                                  // fixed width
                                ...
                                },
                                {
                                  ...
                                  text: `${Intl.NumberFormat("en-US", {
                                    minimumFractionDigits: 2,
                                  }).format(listasaldos[0].dolares_final)}`,
                                  style: "monto",
                                },
                                {
                                  // fixed width
                            ...
                            },
                            {
                              ...
                              layout: {
                                hLineWidth: function (i, node) {
                                  return i === 1 || i === node.table.body.length - 1
                                    ? 1
                                    : 0;
                                },
                            ...
                            },
                            {
                              ...
                              layout: {
                                hLineWidth: function (i, node) {
                                  return i === 2 || i === node.table.body.length - 1
                                    ? 1
                                    : 0;
                                },
                                vLineWidth: function (i, node) {
                                ...
                                // fillColor: function (rowIndex, node, columnIndex) { return null; }
                                fillColor: function (rowIndex, node, columnIndex) {
                                  return rowIndex > 2 && rowIndex % 2 === 1
                                    ? "#e6e6e6"
                                    : null;
                                },
                              },
                        ...
                        pdfDoc.on("end", function () {
                          ...
                          res.setHeader(
                            "Content-Disposition",
                            `attachment; filename=DetalleCaja_${oficina_codigo1}_${moment()
                              .locale("es")
          ...
          .then(resp2 => {
            models.oficina
              .findAll({
                ...
                where: {
                  empresa_codigo: resp2.empresa_codigo,
                },
              })
              .then(lista => {
                res.json(lista);
