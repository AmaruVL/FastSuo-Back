                    ...
                    .create(
                      {
                        ...
                        cliente_razon_social:
                          "RECIBO " + req.body.recibo_tipo + " " + req.body.razon_social, //BODY
                        ...
                        moneda1_Ingre:
                          req.body.moneda === "SOLES"
                            ? req.body.recibo_tipo === "INGRESO" ||
                              req.body.recibo_tipo === "Reciboingreso"
                              ? req.body.importe
                              : 0
                            : 0, //???suma de valores?????? //BODY
                        moneda1_Egre:
                          req.body.moneda === "SOLES"
                            ? req.body.recibo_tipo === "EGRESO" ||
                              req.body.recibo_tipo === "Reciboegreso"
                              ? req.body.importe
                              : 0
                            : 0, //?suma de valores??????			//BODY
                        moneda2_Ingre:
                            ...
                            .create(
                              {
                                ...
                                cliente_razon_social:
                                  "RECIBO ANULACION -" +
                                  (recibo.recibo_tipo === "INGRESO"
                                    ? "EGRESO"
                                    : "INGRESO") +
                                  " - " +
                                  recibo.razon_social, //BODY
                                ...
                                moneda1_Egre:
                                  recibo.moneda === "SOLES"
                                    ? recibo.recibo_tipo === "INGRESO" ||
                                      recibo.recibo_tipo === "Reciboingreso"
                                      ? recibo.importe
                                      : 0
                                    : 0, //?suma de valores??????			//BODY
                                moneda2_Ingre:
