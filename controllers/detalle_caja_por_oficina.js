...
exports.saldos_oficina = (req, res) => {
  ...
  utils.decodeToken(token, tokenDecodificado => {
    ...
    models.sequelize
      .query(`SELECT * FROM saldos_caja2(:fecha_inicio,:fecha_fin,:caja_cod)`, {
        replacements: {
...
exports.listaDetalleOficina = (req, res) => {
  ...
  utils.decodeToken(token, async tokenDecodificado => {
    ...
    models.sequelize
      .query(
        `SELECT * from giros('${caja_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
        {
          type: models.sequelize.QueryTypes.SELECT,
        },
      )
      .then(lista => {
        ...
        models.sequelize
          .query(
            `SELECT * from orden_pago('${caja_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
            {
              type: models.sequelize.QueryTypes.SELECT,
            },
          )
          .then(lista2 => {
            ...
            models.sequelize
              .query(
                `SELECT * from recibos2('${caja_codigo1}','${opcion}', '${fechai}', '${fechaf}')`,
                {
                  type: models.sequelize.QueryTypes.SELECT,
                },
              )
              .then(lista3 => {
                ...
                models.sequelize
                  .query(
                    `SELECT * from servicios_caja('${caja_codigo1}', '${fechai}', '${fechaf}')`,
                    {
                      type: models.sequelize.QueryTypes.SELECT,
                    },
                  )
                  .then(lista4 => {
                    ...
                    models.sequelize
                      .query(
                        `SELECT * from saldos_caja2('${fechai}','${fechaf}','${caja_codigo1}')`,
                        {
                          type: models.sequelize.QueryTypes.SELECT,
                        },
                      )
                      .then(listasaldos => {
                        ...
                        pdfDoc.on("end", function () {
                          ...
                          res.setHeader(
                            "Content-Disposition",
                            `attachment; filename=DetalleCaja_${caja_codigo1}_${moment()
                              .locale("es")
